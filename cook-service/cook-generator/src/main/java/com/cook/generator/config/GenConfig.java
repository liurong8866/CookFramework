package com.cook.generator.config;
...
public class GenConfig
{
    ...
    {
        GenConfig.domainPath = domainPath;
    }
    ...
    {
        GenConfig.mapperPath = mapperPath;
    }

    @Value("${mapperXmlPath}")
    public void setMapperXmlPath(String mapperXmlPath)
    {
        GenConfig.mapperXmlPath = mapperXmlPath;
    }
